...
class IndexController extends ApiController
{
    ...
    {
        $be_online  = (new Article)->getArticlesWithFilter('', 0, '', 1, 0, null, '', 'T', '', '', 'id', 'desc', 3);//新作上线
        $new_update = (new Article)->getArticlesWithFilter('', 0, '', 2, 0, null, '', 'T', '', '', 'id', 'desc', 3);//今日我更新
        $recommend  = (new Article)->getArticlesWithFilter('', 0, '', 3, 0, null, '', 'T', '', '', 'id', 'desc', 6);//无良推荐
        $day_push   = (new Article)->getArticlesWithFilter('', 0, '', 4, 0, null, '', 'T', '', '', 'id', 'desc', 1);//每日一推
        $classical  = (new Article)->getArticlesWithFilter('', 0, '', 5, 0, null, '', 'T', '', '', 'id', 'desc', 3);//日漫经典
