    ...
    <div>
        ...
        <Modal v-model="roleModal.show" :closable='false' :mask-closable=false width="800">
            ...
            <Transfer v-if="roleModal.show" :data="roleModal.allRoles" :target-keys="roleModal.hasRoles"
                      ...
                      filterable @on-change="handleTransferChange">
            </Transfer>
            <div slot="footer">
        ...
        <add-component v-if='addModal.show' @on-add-modal-success='getTableDataExcute(feeds.current_page)'
        ...
        <add-vip-component v-if="addVipModal.show" :user="currentRow"
                           @on-add-modal-success='getTableDataExcute(feeds.current_page)'
                           @on-add-vip-model-hide="addVipModalHide" ></add-vip-component>
...
<script>
    ...
    import AddVipComponent from '../vips/components/add'
                ...
                columns: [{
                    ...
                    },
                    {
                        ...
                        render: (h, params) => {
                            const row = params.row;
                            if (row.vip) {
                                var color = 'green', type = 'md-checkmark';
                            } else {
                                var color = 'red', type = 'md-close';
                            }
                            return h('div', [
                                h('Icon', {
                                    props: {
                                ...
                                h('span', (row.vip ? ' 期限：' + row.vip.expired_at : ''))
                            ])
                        }
                    },
                    {
                        ...
                        render: (h, params) => {
                            ...
                            return h('div', [
                                ...
                                h('Button', {
                                    ...
                                    on: {
                                        click: () => {
                                            t.currentRow = params.row;
                                            t.addVipModal.show = true;
                                        }
                                    }
