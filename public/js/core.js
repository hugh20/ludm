/*
 art-template - Template Engine | http://aui.github.com/artTemplate/ Raven.js 3.26.4 (409f3b4) | github.com/getsentry/raven-js */
!function (t, e) {
    ...
    var e = function () {
        ...
        function V(t) {
            var e, n;
            return f[t] || (e =
                c.createElement(t), c.body.appendChild(e), n = getComputedStyle(e, "").getPropertyValue("display"), e.parentNode.removeChild(e), "none" == n && (n = "block"), f[t] = n), f[t]
        }
        ...
        var e, n, i, r, P, N, o = [], a = o.concat, s = o.filter, u = o.slice, c = t.document, f = {}, l = {},
            ...
            b = ["after", "prepend", "before", "append"], x = c.createElement("table"), E = c.createElement("tr"),
            T = {tr: c.createElement("tbody"), tbody: x, thead: x, tfoot: x, td: E, th: E, "*": c.createElement("div")},
            w = /^[\w-]*$/, S = {}, j = S.toString, C = {}, O = c.createElement("div"), M = {
                tabindex: "tabIndex",
                readonly: "readOnly",
                "for": "htmlFor",
                "class": "className",
        ...
        return C.matches = function (t,
            ...
            if ("string" == typeof t) if (t = t.trim(), "<" == t[0] && p.test(t)) r = C.fragment(t, RegExp.$1, n), t = null; else {
                ...
                if (C.isZ(t)) return t;
                if (D(t)) r = Z(t); else if (R(t)) r = [t], t = null; else if (p.test(t)) r = C.fragment(t.trim(), RegExp.$1, n), t = null; else {
                    if (n !== e) return i(n).find(t);
                    r = C.qsa(c, t)
                }
            }
            ...
            var n, i = "#" == e[0], r = !i && "." == e[0], o = i || r ? e.slice(1) : e, a = w.test(o);
            ...
            wrapInner: function (t) {
                ...
                return this.each(function (n) {
                    var r = i(this), o = r.contents(), a = e ? t.call(this, n) : t;
            ...
            attr: function (t, i) {
                ...
                return "string" != typeof t || 1 in arguments ? this.each(function (e) {
                    if (1 === this.nodeType) if (R(t)) for (n in t) J(this, n, t[n]); else J(this, t, Y(this, i, e, this.getAttribute(t)))
            ...
            offset: function (e) {
                if (e) return this.each(function (t) {
                    var n = i(this), r = Y(this, e, t, n.offset()), o = n.offsetParent().offset(),
                        a = {top: r.top - o.top, left: r.left - o.left};
                    "static" == n.css("position") && (a.position = "relative"), n.css(a)
                });
                if (!this.length) return null;
                if (c.documentElement !== this[0] && !i.contains(c.documentElement, this[0])) return {top: 0, left: 0};
            ...
            toggleClass: function (t, n) {
                return t ? this.each(function (r) {
                    var o = i(this), a = Y(this, t, r, G(this));
            ...
            position: function () {
                if (this.length) {
                    ...
                    return n.top -= parseFloat(i(t).css("margin-top")) || 0, n.left -= parseFloat(i(t).css("margin-left")) || 0, r.top += parseFloat(i(e[0]).css("border-top-width")) ||
                        0, r.left += parseFloat(i(e[0]).css("border-left-width")) || 0, {
                        top: n.top - r.top,
                        left: n.left - r.left
                    }
                }
            ...
            i.fn[n] = function () {
                ...
                return a.length < 1 ? this : this.each(function (e, n) {
                    ...
                    a.forEach(function (e) {
                        if (u) e = e.cloneNode(!0); else if (!s) return i(e).remove();
    ...
    (t.$ = e), function (e) {
        ...
        function S(t, n) {
            if (n || !t.isDefaultPrevented) {
                ...
                (n.defaultPrevented !== i ? n.defaultPrevented : "returnValue" in
        ...
        var i, n = 1, r = Array.prototype.slice, o = e.isFunction, a = function (t) {
                return "string" == typeof t
            }, s = {}, u = {}, c = "onfocusin" in t, f = {focus: "focusin", blur: "focusout"},
        ...
        var r, o, n = +new Date, i = t.document, a = /<script\b[^<]*(?:(?!<\/script>)<[^<]*)*<\/script>/gi,
            s = /^(?:text|application)\/javascript/i, u = /^(?:text|application)\/xml/i, c = "application/json",
            f = "text/html", l = /^\s*$/, h = i.createElement("a");
        h.href = t.location.href, e.active = 0, e.ajaxJSONP = function (r, o) {
            if (!("type" in r)) return e.ajax(r);
            var f, p, a = r.jsonpCallback, s = (e.isFunction(a) ? a() : a) || "Zepto" + n++,
                u = i.createElement("script"), c = t[s], l = function (t) {
                    e(u).triggerHandler("error",
                        t || "abort")
                }, h = {abort: l};
            return o && o.promise(h), e(u).on("load error", function (n, i) {
                clearTimeout(p), e(u).off().remove(), "error" != n.type && f ? y(f[0], h, r, o) : b(null, i || "error", h, r, o), t[s] = c, f && e.isFunction(c) && c(f[0]), c = f = void 0
            ...
            var u, c, a = e.extend({}, n || {}), s = e.Deferred && e.Deferred();
            ...
            var O, d = a.accepts[f], g = {}, x = function (t, e) {
                    g[t.toLowerCase()] = [t, e]
                }, C = /^([\w-]+:)\/\//.test(a.url) ? RegExp.$1 : t.location.protocol,
                P = a.xhr(), N = P.setRequestHeader;
            ...
            if (P.setRequestHeader = x, P.onreadystatechange = function () {
                    if (4 == P.readyState) {
                        ...
                        if (P.status >= 200 && P.status < 300 || 304 == P.status || 0 == P.status && "file:" == C) {
                            if (f = f || w(a.mimeType || P.getResponseHeader("content-type")), "arraybuffer" == P.responseType || "blob" == P.responseType) t = P.response; else {
                                t = P.responseText;
                                try {
            ...
            var s, r = this, o = t.split(/\s/), u = C(t, n, i), c = u.success;
            return o.length > 1 && (u.url = o[0], s = o[1]), u.success = function (t) {
                r.html(s ? e("<div>").html(t.replace(a, "")).find(s) : t), c && c.apply(r, arguments)
            }, e.ajax(u), this
        };
        ...
        function e(t, e) {
            var n = this.os = {}, i = this.browser = {}, r = t.match(/Web[kK]it[\/]{0,1}([\d.]+)/),
                ...
                a = !!t.match(/\(Macintosh; Intel /), s = t.match(/(iPad).*OS\s([\d_]+)/),
                u = t.match(/(iPod)(.*OS\s([\d_]+))?/), c = !s && t.match(/(iPhone\sOS)\s([\d_]+)/),
                f = t.match(/(webOS|hpwOS)[\s\/]([\d.]+)/), l = /Win\d{2}|Windows/.test(e),
                h = t.match(/Windows Phone ([\d.]+)/), p = f && t.match(/TouchPad/), d = t.match(/Kindle\/([\d.]+)/),
                m = t.match(/Silk\/([\d._]+)/), g = t.match(/(BlackBerry).*Version\/([\d.]+)/),
                v = t.match(/(BB10).*Version\/([\d.]+)/), y = t.match(/(RIM\sTablet\sOS)\s([\d.]+)/),
                b = t.match(/PlayBook/), x = t.match(/Chrome\/([\d.]+)/) ||
                t.match(/CriOS\/([\d.]+)/), E = t.match(/Firefox\/([\d.]+)/),
        ...
        var i, r, o, a, u, n = {}, s = 750;
        e(document).ready(function () {
            var m, g, b, x, v = 0, y = 0;
            "MSGesture" in t && (u = new MSGesture, u.target = document.body), e(document).bind("MSGestureEnd",
                function (t) {
            ...
            }).on("touchcancel MSPointerCancel pointercancel", h), e(t).on("scroll", h)
...
!function () {
    ...
    function c(c, d) {
        ...
        var g = d.debug, h = d.openTag, i = d.closeTag, j = d.parser, k = d.compress, l = d.escape, m = 1,
            p = {$data: 1, $filename: 1, $utils: 1, $helpers: 1, $out: 1, $line: 1}, q = "".trim, s =
    ...
    var e = d.defaults = {
        openTag: "<%", closeTag: "%>", escape: !0,
        cache: !0, compress: !1, parser: null
    }, f = d.cache = {};
...
(function () {
        ...
        if (!Event.prototype.stopImmediatePropagation) {
            o.removeEventListener =
                function (l, s, i) {
                    ...
                    if (l === "click") r.call(o, l, s.hijacked || s, i); else r.call(o, l, s, i)
                };
    ...
    d.prototype.touchHasMoved = function (h) {
        var j = h.changedTouches[0], i = this.touchBoundary;
    ...
    d.prototype.onMouse = function (h) {
        ...
        if (!this.needsClick(this.targetElement) || this.cancelNextClick) {
            if (h.stopImmediatePropagation) h.stopImmediatePropagation(); else h.propagationStopped = true;
            h.stopPropagation();
            h.preventDefault();
            return false
        }
    ...
    return function a(b, c, d) {
        ...
        1: [function (a, b, c) {
                ...
                if (b in a) {
                    ...
                    a[b] = function () {
                        var a = [].slice.call(arguments),
                            h = d.safeJoin(a, " "), i = {level: g, logger: "console", extra: {arguments: a}};
            ...
            (function (c) {
                ...
                var g = a(6), h = a(7), i = a(8), j = a(1), k = a(5), l = k.isErrorEvent, m = k.isDOMError,
                    n = k.isDOMException, o = k.isError, p = k.isObject, q = k.isPlainObject, r = k.isUndefined,
                    s = k.isFunction, t = k.isString, u = k.isArray, v = k.isEmptyObject, w = k.each, x = k.objectMerge,
                    y = k.truncate, z = k.objectFrozen, A = k.hasKey, B = k.joinRegExp, C = k.urlencode, D = k.uuid4,
                    E = k.htmlTreeAsString,
                    F = k.isSameException, G = k.isSameStacktrace, H = k.parseUrl, I = k.fill, J = k.supportsFetch,
                    K = k.supportsReferrerPolicy, L = k.serializeKeysForMessage, M = k.serializeException,
                    N = k.sanitize, O = a(2).wrapMethod, P = "source protocol user pass host port path".split(" "),
                    Q = /^(?:(\w+):)?\/\/(?:(\w+)(:\w+)?@)?([\w\.-]+)(?::(\d+))?(\/.*)/,
                    R = "undefined" != typeof window ? window : "undefined" != typeof c ? c : "undefined" != typeof self ? self : {},
                    S = R.document, T = R.navigator;
                f.prototype = {
                    VERSION: "3.26.4", debug: !1, TraceKit: g, config: function (a, b) {
                        var c =
                            this;
                        ...
                        var b = this, c = b.G(a), d = c.path.lastIndexOf("/"), e = c.path.substr(1, d);
                        ...
                        function d() {
                            ...
                            try {
                                ...
                                throw e.L(), e.captureException(h$6, a), h$6;
                            }
                        }
                        ...
                        if (b = x({trimHeadFrames: 0}, b ? b : {}), l(a) && a.error) a = a.error; else {
                            if (m(a) ||
                                n(a)) {
                        ...
                        var c = Object.keys(b).sort(), d = x(a, {
                            message: "Non-Error exception captured with keys: " +
                            L(c), fingerprint: [i(c)], extra: a.extra || {}
                        });
                        ...
                        if (!this.k.ignoreErrors.test || !this.k.ignoreErrors.test(a)) {
                            ...
                            c.name = null;
                            var f = g.computeStackTrace(c), h = u(f.stack) && f.stack[1];
                        ...
                        if (s(this.k.breadcrumbCallback)) {
                            ...
                            if (p(c) && !v(c)) b = c; else if (c === !1) return this
                        }
                        ...
                        if (S) {
                            ...
                            var f = this.J(this.G(a.dsn)), g = S.createElement("script");
                        ...
                        if (this.b) {
                            ...
                            for (d in b) A(b,
                                d) && (c[d] = b[d]);
                            if (S.createEvent) S.dispatchEvent(c); else try {
                        ...
                        var c = H(this.w.href), d = H(b), e = H(a);
                        ...
                        function a(a) {
                            return function (b, d) {
                                ...
                                return s(g) && (e[0] = c.wrap({
                                    mechanism: {
                                        type: "instrument",
                                        data: {"function": a.name || "<anonymous>"}
                                    }
                        ...
                        for (var f = ["EventTarget", "Window", "Node", "ApplicationCache", "AudioTrackList", "ChannelMergerNode",
                            "CryptoOperation", "EventSource", "FileReader", "HTMLUnknownElement", "IDBDatabase", "IDBRequest", "IDBTransaction", "KeyOperation", "MediaController", "MessagePort", "ModalWindow", "Notification", "SVGElementInstance", "Screen", "TextTrack", "TextTrackCue", "TextTrackList", "WebSocket", "WebSocketWorker", "Worker", "XMLHttpRequest", "XMLHttpRequestEventTarget", "XMLHttpRequestUpload"], g = 0; g < f.length; g++) b(f[g])
                    }, E: function () {
                        function a(a, c) {
                            a in c && s(c[a]) && I(c, a, function (c) {
                                return b.wrap({
                                    mechanism: {
                                        type: "instrument",
                                        data: {"function": a, handler: c && c.name || "<anonymous>"}
                                    }
                                }, c)
                            })
                        }
                        ...
                        var f = R.chrome, g = f && f.app && f.app.runtime,
                        ...
                        b = b || {}, b.mechanism = b.mechanism || {type: "onerror", handled: !1}, this.m || this.V(a, b)
                    }, V: function (a, b) {
                        var c = this.X(a,
                            b);
                        ...
                        if (this.c || this.b) {
                            var a = {};
                            return this.c && T.userAgent && (a.headers = {"User-Agent": T.userAgent}),
                        ...
                        var b = this.k, c = {project: this.i, logger: b.logger, platform: "javascript"}, e = this.ja();
                        ...
                        if (this.isSetup()) {
                            ...
                            (d.transport || this._makeRequest).call(this, {
                                url: g, auth: e, data: a, options: d, onSuccess: function () {
                                    c.y(), c.$("success", {data: a, src: g}), b && b()
                                }, onError: function (d) {
                        ...
                        if (g) {
                            ...
                            i && ("withCredentials" in g ? g.onreadystatechange = function () {
                                if (4 === g.readyState) if (200 === g.status) a.onSuccess && a.onSuccess(); else if (a.onError) {
        ...
        }, {1: 1, 2: 2, 5: 5, 6: 6, 7: 7, 8: 8}], 4: [function (a, b, c) {
            (function (c) {
                var d = a(3),
            ...
            (function (c) {
                ...
                function v(a, b) {
                    var c, d;
                    if (i(a.length)) for (c in a) z(a, c) && b.call(null,
                        c, a[c]); else if (d = a.length) for (c = 0; c < d; c++) b.call(null, c, a[c])
                }
            ...
            (function (c) {
                ...
                var f = a(5), g = {collectWindowErrors: !0, debug: !1},
                ...
                g.report = function () {
                    ...
                    function l(a, b, c, h, i) {
                        var l = null, m = f.isErrorEvent(i) ? i.error : i, n = f.isErrorEvent(a) ? a.message : a;
                        if (v) g.computeStackTrace.augmentStackTraceWithInitialElement(v, b, c, n), o(); else if (m && f.isError(m)) l = g.computeStackTrace(m), e(l, !0); else {
                            var p, r = {url: b, line: c, column: h}, s = void 0;
                    ...
                    function c(a, e) {
                        for (var h, i, k = /function\s+([_$a-zA-Z\xA0-\uFFFF][_$a-zA-Z0-9\xA0-\uFFFF]*)?\s*\(/i,
                                 l = [], m = {}, n = !1, o = c.caller; o && !n; o = o.caller) if (o !== f && o !== g.report) {
                            if (i = {
                                    url: null,
                                    func: j,
                                    line: null,
                    ...
                    function f(b, e) {
                        ...
                        try {
                            ...
                            if (g.debug) throw h$27;
                        }
                        try {
                            if (f = c(b, e + 1)) return f
                        } catch (h$28) {
                            if (g.debug) throw h$28;
                        }
...
(function () {
    var __makeExtend = function (Parent) {
        return function (extProto) {
            ...
            var childProto = Parent ? new Parent({name: "__for__proto__"}) : {};
    ...
    var BIU = baseExtend({
        "__construct": function (opt) {
            ...
            var listener = {__this: this, __func: func}, listeners;
            ...
            if (typeArg === "*:*") listeners = this.__allListeners; else if (unitName === "*") listeners = listeners.concat(this.__typeListenerMap[typeName] || []); else if (typeName === "*") listeners = listeners.concat(this.__unitListenerMap[unitName] || []); else listeners = listeners.concat(this.__typeUniListenerMap[typeArg] || []);
            var args = [].slice.call(arguments, 1), i, len = listeners.length, listener;
            args[0] = e;
            for (i = 0; i < len; i++) {
            ...
            for (i =
                     0; i < len; i++) {
                listener = listeners[i];
                var __this = listener.__this, __func = listener.__func;
            ...
            var __values = [], __context = this;
            while (__context) {
                if (__context.hasOwnProperty(prop) && __context[prop]) __values.push(__context[prop]); else __values.push(undefined);
    ...
    BIU.Page = BIU.extend({
        "__construct": function (opt) {
            ...
            this.on("*", function (e) {
                ...
                var args = [].slice.call(arguments, 0), list = this.__models.concat(this.__views, this.__children), i,
            ...
            var models = [], views = [], children =
                [], item, _set;
            if (!Array.isArray(list)) list = [list];
            for (var i = 0, len = list.length; i < len; i++) {
                item = list[i];
                _set = null;
                if (BIU.Model.__instances[item.name] || BIU.Model.__instances[item]) _set = models; else if (BIU.View.__instances[item.name] || BIU.View.__instances[item]) _set = views; else _set = children;
                _set && _set.push(item)
            }
            this.__addList(this.__models, models);
            this.__addList(this.__views, views);
            ...
            var data = this.find(name, "model"), args = Array.prototype.slice.apply(arguments, [1]);
            if (data && typeof data.load === "function") return data.load.apply(data, args);
            return null
        }, "set": function (name) {
            var child = this.find(name, "model"), args = Array.prototype.slice.apply(arguments,
                [1]);
    ...
    BIU.Model = BIU.extend({
        ...
        }, "__data": null, "__load": function () {
            this.__data = null
        }, "__get": function () {
            return this.__data
        }, "__set": function (value) {
            var args = Array.prototype.slice.apply(arguments, [0]), argLen = args.length;
            if (argLen > 1) {
                var data = this.__data, key;
                while (args.length > 2) {
                    key = args.shift();
    ...
    BIU.View = BIU.extend({
        "__construct": function (opt) {
            ...
            var t = key.split(" "), type = t.shift(), sl = t.join(" ");
            ...
            for (var i = 0, len = elem.length; i < len; i++) {
                var _elem = elem[i], _listener = listener.bind ? listener.bind(this) : function (context, func) {
                    return function () {
...
(function e(t, n, r) {
    ...
    1: [function (require, module, exports) {
        ...
        function DialogButton(opt) {
            ...
            var text = opt.text || "", style = opt.style || {}, className = opt.className || "dialog-btn";
            self.opt = opt;
            self.text = opt.text;
        ...
        dialogTypes.register("BUTTON", DialogButton, [dialogPrototypes.ENTITY, dialogPrototypes.IN_CONTAINER], function parser(thing) {
            if (thing instanceof Object && typeof thing.text === "string" && typeof thing.click === "function") return new DialogButton(thing); else return null
    ...
    }, {"./_dialog-prototypes.js": 5, "./_dialog-types.js": 7}], 2: [function (require, module,
                                                                               exports) {
        var dialogTypes = require("./_dialog-types.js"), dialogPrototypes = require("./_dialog-prototypes.js");
        ...
        dialogTypes.register("CHILD", DialogChild, [dialogPrototypes.ENTITY, dialogPrototypes.IN_CONTAINER], function parser(thing) {
            if (thing instanceof HTMLElement) return new DialogChild({dom: thing}); else return null
        }, function comparator(instance, thing) {
            return instance ===
        ...
        function DialogPara(opt) {
            ...
            var text = opt.text || "", style = opt.style || {}, className = opt.className || "dialog-para";
            self.text = opt.text;
        ...
        dialogTypes.register("PARA", DialogPara, [dialogPrototypes.ENTITY, dialogPrototypes.IN_CONTAINER], function parser(thing) {
            if (typeof thing === "string") return new DialogPara({text: thing}); else return null
        }, function comparator(instance, thing) {
        ...
        DialogPromise.prototype = {
            "construct": DialogPromise, "resolve": function (result) {
                ...
                this.callbacks.push({resolve: successHandler, reject: failedHandler});
                return this
            }
        }
    }, {}], 5: [function (require, module, exports) {
        var dialogUtils =
            require("./_dialog-utils.js"), dialogTypes = require("./_dialog-types.js");
        module.exports = {
            ENTITY: {
                ...
                "prepend": function (thing, _index) {
                    var self = this, child = dialogTypes.tryParse(thing);
                    if (!child) {
                    ...
                    var self = this, index = _index | 0, children = self.children;
                    if (child._parent) child._parent.remove(child);
                    child._parent = self;
                    children.splice(index, 0, child);
                    var nextNode = dialogUtils.getChildElem(self.dom, index);
                    if (nextNode) self.dom.insertBefore(child.dom, nextNode); else self.dom.appendChild(child.dom)
                    ...
                    var self = this, children = self.children, child = null;
                    if (thing.dialogType && children.indexOf(thing) >= 0) child = thing; else if (typeof thing === "number") {
                    ...
                    var self = this, child = self.find(thing);
                    if (!child) return;
                    this._remove(child)
                    ...
                    var self = this, children = self.children, len = children.length;
                    for (var i = 0, child; i < len && (child = children[i]); i++) delete child._parent;
                    self.children = [];
                    self.dom.innerHTML = ""
                }, "setContent": function (content) {
                    var self = this, arr = content.length === undefined ? [content] : content;
                    self.clear();
                ...
                "prev": function () {
                    var self =
                            this, parent = self && self._parent, children = parent && parent.children,
                        pos = children && children.indexOf(self);
                    return pos >= 0 && parent && parent.find && parent.find(pos - 1)
                }, "next": function () {
                    var self = this, parent = self && self._parent, children = parent && parent.children,
                        pos = children && children.indexOf(self);
                    return pos >= 0 && parent && parent.find && parent.find(pos + 1)
                }, "parent": function () {
                    var self = this;
        ...
        function DialogRow(opt) {
            ...
            self.children = [];
            var content = opt.content || "", style = opt.style || {}, className = opt.className || "dialog-row";
            self.opt = opt;
        ...
        module.exports = {
            register: function (name, constructor, prototypes, parser, comparator) {
                ...
                var name = instance.dialogType, comparator = comparators[name];
                return comparator &&
        ...
        var dialogUtils = {
            NODE_TYPES: {
                ...
                var undefined = void 0, basePrototypes = Array.prototype.slice.call(arguments, 1);
                while (basePrototype = basePrototypes.shift()) for (var p in basePrototype) if (basePrototype.hasOwnProperty(p) &&
                ...
                var childNodes = dom.childNodes, TYPES = this.NODE_TYPES, _pos = 0, _index = 0, node;
        ...
        var dialogUtils = require("./_dialog-utils.js"), dialogTypes = require("./_dialog-types.js"),
            dialogPrototypes = require("./_dialog-prototypes.js"), WRAP_CLASS_NAME = "dialog-wrap",
            TRANSITION_TIME = 300, TEMPLATE_TEXT = null;
        ...
        function Dialog(opt) {
            ...
            var prop = opt.prop || {
                skin: "default", cover: true, closeBtn: true,
                lock: false
            }, title = opt.title || "", content = opt.content || "", onOpen = opt["onOpen"], onClose = opt["onClose"];
            self.children = [];
            self.prop = {};
            self.doms = {};
            self.callbacks = {};
    ...
    }, {"./_dialog-prototypes.js": 5, "./_dialog-types.js": 7, "./_dialog-utils.js": 8}],
    10: [function (require, module, exports) {
        var _loaded = false, _cbs = [];
        var DOMLoadState = module.exports = {
            isLoaded: function () {
                ...
                var self = this, onLoad = function () {
                    self._onLoad()
                };
                if (document.addEventListener) document.addEventListener("DOMContentLoaded", onLoad); else if (window.addEventListener) window.addEventListener("load", onLoad); else if (window.attachEvent) window.attachEvent("onload", onLoad)
            }, _onLoad: function () {
                _loaded = true;
        ...
        var dialogUtils = require("./_dialog-utils.js"), Promise = require("./_dialog-promise.js"),
            Dialog = require("./_dialog.js"), DialogChild = require("./_dialog-child.js"),
            DialogPara = require("./_dialog-para.js"), DialogButton = require("./_dialog-button.js"),
            DialogRow = require("./_dialog-row.js"), DOMLoadState = require("./_dom-load-state.js");
        var initializer = module.exports = {
            _initialized: false, _creators: [], init: function (opts) {
                var self = this,
                    initialized = self._initialized, transitionTime = opts["transitionTime"] || 300,
                    dialogWrapClassName = opts["dialogWrapClassName"] || "pile-dialog-wrap",
                    templateText = opts["templateText"] || "", styleText = opts["styleText"] || "";
                ...
                if (DOMLoadState.isLoaded()) self._doCreate(); else DOMLoadState.whenLoad(function () {
                    self._doCreate()
                })
        ...
        initializer.lazyCreate("toastDialog", "toast", function () {
            Dialog.toastDialog = new Dialog({
                prop: {skin: "toast", cover: false, closeBtn: false, lock: false},
                content: [""]
            });
        ...
        initializer.lazyCreate("alertDialog", "alert", function () {
            Dialog.alertDialog = new Dialog({
                prop: {
                    skin: "default",
                    cover: true, closeBtn: true, lock: false
                }, content: [{
            ...
            Dialog.alertDialog.on("close", function (e) {
                var dialog = this, promise = dialog._promise, resolved = dialog._resolved;
                promise && (resolved ? promise.resolve(e) : promise.reject(e))
            });
            Dialog.alert = function (contents, title, btnText) {
                var dialog = Dialog.alertDialog, btnOk = dialog.find(-1), promise = new Promise;
        ...
        initializer.lazyCreate("confirmDialog", "confirm", function () {
            Dialog.confirmDialog = new Dialog({
                prop: {skin: "default", cover: true, closeBtn: true, lock: true}, content: [new PileDialogRow({
                    content: [{
                        text: "\u53d6\u6d88", style: {flex: 1}, click: function () {
                            var dialog =
                                this.dialog();
                            dialog._resolved = false;
                            dialog.close()
                        ...
                        text: "\u786e\u5b9a", style: {flex: 1, marginLeft: 0}, click: function () {
                            var dialog = this.dialog();
                            dialog._resolved = true;
                            dialog.close()
                        }
            ...
            Dialog.confirm = function (contents, title, btnTextCancel, btnTextConfirm) {
                var dialog = Dialog.confirmDialog, btnRow = dialog.find(-1), promise = new Promise,
                    btnText = {cancel: btnTextCancel || "\u53d6\u6d88", confirm: btnTextConfirm || "\u786e\u5b9a"};
                if (!dialogUtils.isArray(contents)) contents = [contents];
        ...
        (function () {
            ...
            initializer.init({templateText: templateText, styleText: styleText});
            module.exports = initializer.expose()
        })()
    }, {"./js/_initializer.js": 11}]
}, {}, [12]);
(function () {
    console.log("EasyKit (v2.8.4)\n\n" + (new Array(16)).join("="));
    var CLIENT = {
    ...
    function deepCopy(origin, _copy) {
        var type = Object.prototype.toString.call(origin), copy = origin;
        switch (type) {
            case "[object Object]":
                copy = _copy || {};
    ...
    var makeSureWindowLoaded = {
        _loaded: false, _loadEvent: null, _loadCallbacks: [], wrap: function wrap(func) {
            if (this._loaded) func(this._loadEvent); else this._loadCallbacks.push(func)
    ...
    var anonymousCallbackExposer = {
        KEY: "_anonymous_callbacks", _callbacks: {}, _genCallbackID: function _genCallbackID() {
            var id = null;
            do id = "cb_" +
                Date.now() + "_" + String(Math.random()).substring(2); while (this._callbacks[id]);
            return id
        }, _delCallbackID: function _delCallbackID(id) {
            delete this._callbacks[id]
        }, expose: function expose(func, keepAfterExec) {
            var self = this, id = self._genCallbackID(), name = ["window", self.KEY, id].join(".");
            ...
            if (parentWindow) {
                ...
                if (!parentCallbacks) parentWindow[self.KEY] =
                    self._callbacks; else parentCallbacks[id] = self._callbacks[id]
            }
            return name
        }, parse: function parse(name) {
            if (typeof name === "string") {
                var arr = name.split("."), context = window, level = 0, cur;
                while (cur = arr.shift()) {
                    level++;
    ...
    function toJSON(obj, _last) {
        var buffer = [], type = Object.prototype.toString.call(obj), last = _last || [];
    ...
    function getQueryString(name) {
        var search = getSearch(), result = search.match(new RegExp("[\\?\\&]" + name + "=([^\\&]+)", "i"));
        if (result == null || result.length < 1) return "";
        return decodeURIComponent(result[1])
    }

    function getPathQueryString(name) {
        var pathName = getPathName(), tmp = pathName.split("/");
        for (var i = 1, l = tmp.length; i < l; i += 2) {
            var key = tmp[i], value = decodeURIComponent(tmp[i + 1]);
            if (key ===
                name) return value
        }
        return ""
    ...
    function getQueryStringSet(_url) {
        var url = _url || window.location.href, queryString = (url.split("#")[0].split("?")[1] || "").split("&"),
            queryStringSet = {};
        for (var i = 0, l = queryString.length; i < l; i++) {
            var qs = queryString[i];
            if (!qs) continue;
            var tmp = qs.split("="), name = tmp[0] || "", value = tmp[1] || "";
    ...
    function appendQueryString(_url, queryStringSet) {
        var modCurrent = arguments.length === 1 && Object.prototype.toString.call(arguments[0]) ===
            "[object Object]";
        if (modCurrent) {
            queryStringSet = arguments[0];
            _url = null
        }
        var url = _url || window.location.href, buffer = [], joinedSet = getQueryStringSet(url), name, value;
        ...
        if (modCurrent) window.history && window.history.replaceState &&
    ...
    function setCookie(key, value, expires, domain, path) {
        ...
        if (expires) if (typeof expires === "number") {
            ...
            expiresTime.setMinutes(expiresTime.getMinutes() +
                expires);
    ...
    var cookieHelper =
        {setCookie: setCookie, removeCookie: removeCookie, getCookie: getCookie};
    ...
    function use() {
        ...
        (function () {
            ...
            var _d, _l, _b, _n = "-", _params, _curDomain, _curUrl, _domainToSet, _refDomain, _refUrl, _image, _ext,
                _hurlcn, _tt, _ch = 0, _crossDomain = 0;
            _ver = "tcss.3.1.5", _speedTestUrl =
                "http://jsqmt.qq.com/cdn_djl.js", window.Tcss = {};
            ...
            tcss.prototype = {
                init: function init(e) {
                    ...
                    typeof _d == "undefined" && (_d = document), _l = _d.location, _b = _d.body, _pgvVersion && (Tcss.d = _d, Tcss.l = _l),
                        _ext = [], _hurlcn = [], _tt = []
                }, run: function run() {
                    var e, t, n;
                    ...
                    this.url.push(this.getMainEnvInfo()),
                        this.url.push(this.getExtendEnvInfo()), Tcss.pgUserType = "";
                    ...
                    _pgvVersion && (pgvGetColumn(), pgvGetTopic(), this.url.push("&column=" + Tcss.column + "&subject=" + Tcss.subject), tracert()), this.url.push("&vs=" + _ver), _cookie.setCookie("ts_uid", !0), t = (new Date).getTime(), _ext.push("tm=" + (t - e)), _ch && _ext.push("ch=" + _ch), _params.extParam ? n = _params.extParam +
                        "|" : n = "", this.url.push("&ext=" + escape(n + _ext.join(";"))), this.url.push("&hurlcn=" + escape(_hurlcn.join(";"))), this.url.push("&rand=" + Math.round(Math.random() * 1E5)), typeof _speedMark == "undefined" ? this.url.push("&reserved1=-1") : this.url.push("&reserved1=" + (new Date - _speedMark));
                    var s = this.getSud();
                    ...
                    if (_params.crossDomain &&
                        _params.crossDomain == "on") {
                        var e = this.getParameter("tcss_uid", _d.URL), t = this.getParameter("tcss_sid", _d.URL),
                            n = this.getParameter("tcss_refer", _d.URL), r = this.getParameter("tcss_last", _d.URL);
                    ...
                    var t, n;
                    return t = _l.hostname.toLowerCase(), _params.virtualDomain && (_hurlcn.push("ad=" + t), t = _params.virtualDomain),
                        n = this.getCurrentUrl(), Tcss.dm = t, _pgvVersion && pgvGetDomainInfo(), _curDomain = Tcss.dm, _domainToSet || (_domainToSet = this.getCookieSetDomain(_l.hostname.toLowerCase()), _pgvVersion && (Tcss.domainToSet = _domainToSet)), e && (Tcss.dm += ".hot"), "dm=" + Tcss.dm + "&url=" + Tcss.url
                    ...
                    _params.virtualURL && (_hurlcn.push("au=" +
                        e), e = _params.virtualURL), Tcss.url = e, Tcss.arg = t
                    ...
                    var l = t;
                    _params.virtualRefDomain && (t != _n && _hurlcn.push("ard=" + t), t = _params.virtualRefDomain), _params.virtualRefURL && (n !=
                    _n && _hurlcn.push("aru=" + escape(n)), n = _params.virtualRefURL);
                    var c;
                    ...
                    if (!(_refDomain == _n || ("," + d + ",").indexOf(_refDomain) > -1 || _crossDomain ==
                            1)) {
                    ...
                    try {
                        ...
                        self.screen && (t = screen.width + "x" + screen.height, n = screen.colorDepth + "-bit"), u.language ? r =
                            u.language.toLowerCase() : u.browserLanguage && (r = u.browserLanguage.toLowerCase()), o = u.javaEnabled() ? 1 : 0, i = u.platform, s = (new Date).getTimezoneOffset() / 60, e = "&scr=" + t + "&scl=" + n + "&lang=" + r + "&java=" + o + "&pf=" + i + "&tz=" + s
                    } catch (a) {
                    } finally {
                        return e
                    }
        ...
        (function () {
            ...
            t.prototype = {
                init: function init(a) {
                    ...
                    if (f.crossDomain &&
                        "on" == f.crossDomain) {
                        var a = this.getParameter("tcss_uid", g.URL), c = this.getParameter("tcss_sid", g.URL),
                            b = this.getParameter("tcss_refer", g.URL), d = this.getParameter("tcss_last", g.URL);
    ...
    var __defaultOpt = {
        ...
        virtualUrl: function virtualUrl() {
            ...
            var basePathParts = pathParts.pop().split(".");
            if (basePathParts.length > 1) basePathParts.pop();
            pathParts.push(basePathParts.join("."));
            for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) args[_key] =
                arguments[_key];
            if (args.length) pathParts = [].concat(_toConsumableArray(pathParts), args); else pathParts.push(clientType);
            return pathParts.join("/")
        },
        withSearch: true,
        downAppTag: function downAppTag() {
            for (var _len2 = arguments.length, args = Array(_len2), _key2 = 0; _key2 < _len2; _key2++) args[_key2] = arguments[_key2];
            return ["app_down"].concat(args, [clientType, os]).slice(-4).join(".")
        },
    ...
    function reportVisit() {
        var virtualUrl = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : getVirtualUrl();
        var virtualDomain = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : getVirtualDomain();
        var params = {"repeatApplay": "true"};
        if (virtualUrl) params["virtualURL"] =
            virtualUrl;
    ...
    function downAppAndReport() {
        var appUrl = arguments.length >
        0 && arguments[0] !== undefined ? arguments[0] : getAdUrl();
        var downAppTag = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : getDownAppTag();
        var virtualDomain = arguments[2];
        reportClick(downAppTag, virtualDomain);
        window.setTimeout(function () {
    ...
    function setAdUrls(_ref) {
        var iPad = _ref.url_ipad, iOS = _ref.url_ios, android = _ref.url_android;
    ...
    function getDefaultAdUrl() {
        var iPadAppUrl =
            __defaultOpt.iPadAppUrl, iOSAppUrl = __defaultOpt.iOSAppUrl, androidAppUrl = __defaultOpt.androidAppUrl;
        return isIPad ? iPadAppUrl || iOSAppUrl : isIOS ? iOSAppUrl : androidAppUrl
    }

    function getAdUrl() {
        var iPadAppUrl = __opt.iPadAppUrl, iOSAppUrl = __opt.iOSAppUrl, androidAppUrl = __opt.androidAppUrl;
        return isIPad ? iPadAppUrl || iOSAppUrl : isIOS ? iOSAppUrl : androidAppUrl
    }
    ...
    function ajax(_options) {
        var options = convertArgs(Array.prototype.slice.call(arguments,
            0)), ajaxEntity = new AjaxEntity(options);
        window.setTimeout(function () {
            ajaxEntity.send()
        }, 0);
        return ajaxEntity
    ...
    var convertArgs = function convertArgs(args) {
        ...
        if (Object.prototype.toString.call(args[0]) === "[object Object]") {
            ...
            var _prop = ["url", "type",
                    "data", "timeout", "async", "rawResult", "pathArgs", "success", "error"],
                _type = ["string", "string", "object", "number", "boolean", "boolean", "boolean", "function", "function"];
            for (i = 0; (p = _prop[i]) && (t = _type[i]); i++) {
    ...
    var AjaxEntity = function () {
        ...
        _createClass(AjaxEntity, [{
            key: "send", value: function send(_data) {
                var self = this, options = self.options, status = self.status;
                self.data = _data ? options.data = _data : options.data;
                var xhr = self.createXHR(), undefined = void 0, url = String(options.url),
                    type = String(options.type || options.method).toLowerCase(), async = !!options.async,
                    timeout = parseInt(options.timeout), isGet = type === "get", isPost = type === "post",
                    stamp = "t=" + String((new Date).getTime()), sp = url.indexOf("?") <
                    0 ? "?" : "&", finalUrl = url + sp + stamp, encodedData = status.encodedData = self.encodeData(),
                    finalData = undefined;
            ...
            key: "_xhrFinish", value: function _xhrFinish(code, res) {
                var self = this, options = self.options, status = self.status;
            ...
            key: "_abortTimeout", value: function _abortTimeout(time) {
            ...
            key: "_complete", value: function _complete(code, res, ex) {
                var self = this, options = self.options, status = self.status, abortTimeout = status.abortTimeout;
                if (status.completed) return;
                status.completed = true;
                abortTimeout && window.clearTimeout(abortTimeout);
                delete status.abortTimeout;
                var success = options.success, error = options.error;
                if (code == 200) success.apply(this, [res]); else error.apply(this, [code, res, ex])
            }
        }, {
            ...
            key: "encodeData", value: function encodeData() {
                var self = this, data = self.data, enJson = window.JSON && JSON.stringify, buffer = [];
        ...
        if (needUniversal && isIOS) {
            ...
            var callSchemeInWX = function callSchemeInWX() {
                WeixinJSBridge.invoke("launchApplication",
                    {schemeUrl: msg}, function (res) {
                        if (res.err_msg == "launchApplication:ok") return;
                        ccb()
                    })
            };
            if (window.WeixinJSBridge && typeof WeixinJSBridge.invoke == "function") callSchemeInWX(); else if (document.addEventListener) document.addEventListener("WeixinJSBridgeReady", callSchemeInWX, false); else if (document.attachEvent) {
            ...
            var onGotApi = function onGotApi() {
                if (isAndroid) mqq.app.isAppInstalled("com.qq.ac.android",
                    function (result) {
                        if (result) commonLoadScheme(msg); else ccb()
                    }); else {
                    mqq.app.launchApp({name: msg});
                    setTimeout(function () {
                        ccb()
                    }, 3E3)
                }
    ...
    function commonLoadScheme(msg) {
        var ua = window.navigator.userAgent, isMQQBrowser = clientType == CLIENT.QQBROWSER,
            isChrome = (ua.match(/Chrome\/([\d.]+)/) || ua.match(/CriOS\/([\d.]+)/)) && !isMQQBrowser,
            isSafari = ua.match(/Safari\/([\d.]+)\s*$/) &&
                !isMQQBrowser, domType = isIOS && isSafari || isAndroid && isChrome ? "A" : "IFRAME", total = 10;
        if (!doms) {
            doms = {box: null, lastUsed: 0, list: []};
        ...
        var index = (doms.lastUsed + 1) % total, dom = doms.list[index];
        doms.lastUsed = index;
        if (isIOS && isSafari) location.href = msg; else if (domType == "A") {
            dom.href =
                msg;
            dom.click()
        } else dom.src = msg
    ...
    var Pre_Callbacks = {
        unLogin: function unLogin(res) {
            if (window.Dialog) Dialog.alert("\u767b\u5f55\u624d\u80fd\u53c2\u4e0e\u54e6~~",
                " ", "\u53bb\u767b\u5f55~").then(function () {
                ek.ac.User.Login()
            }); else {
                alert("\u767b\u5f55\u624d\u80fd\u53c2\u4e0e\u54e6~~");
            ...
            if (window.Dialog) Dialog.alert(res.msg); else alert(res.msg)
        }, discardApi: function discardApi(res) {
            if (window.Dialog) Dialog.alert("\u9875\u9762\u9519\u8befQAQ<br>\u622a\u56fe\u8054\u7cfbQQ\uff1a1931804005\uff1b<br>\u9875\u9762\u7f51\u5740\uff1a" + window.location.href); else alert("\u9875\u9762\u9519\u8befQAQ\n\u622a\u56fe\u8054\u7cfbQQ\uff1a1931804005\uff1b\n\u9875\u9762\u7f51\u5740\uff1a" +
    ...
    if (isIOSApp) {
        var iframes = {box: null, lastUsed: 0, list: []};
        var total = 10;
        ...
        var callClientForiOS = function callClientForiOS(href, port) {
            ...
            for (var i = 0; i < total; i++) if (!iframes.list[i].src || iframes.list[i].getAttribute("data-use") == "true") {
                ...
                iframes.list[i].setAttribute("data-port",
                    port);
    ...
    function checkParams(key, val, className, methodName) {
        ...
        switch (key) {
            case "comic_id": {
                ...
                if (Number.isInteger(val) && val > 0 && val < 999999999) ; else {
            ...
            case "rank_id": {
                val = Number(val) ? Number(val) : val;
                if (Number.isInteger(val) && val > 0 && val < 100) ; else {
                    showMistake(val, "\u8d85\u51fa\u8303\u56f4");
                    return false
                }
                break
            ...
            case "uin": {
                ...
                if (Number.isInteger(val) && val > 0) ; else {
            ...
            case "key": {
                if (className == "Client" && methodName == "CallUpComicList") if (typeof val == "string") ; else {
            ...
            case "tap": {
                if (className == "Client" && methodName ==
                    "CallUpComicDetail") if (val == "info" || val == "catalog") ; else {
            ...
            case "money": {
                var list = [6, 30, 50, 98, 128, 168, 1, 3, 8, 18, 68, 288];
                var flag = false;
                for (var i = 0, length = list.length; i < length; i++) if (val == list[i]) flag = true;
                if (!flag) {
            ...
            case "type": {
                if (className ==
                    "Client" && methodName == "CallUpComicList") if (val == 1 || val == 2) ; else {
                    showMistake(val, "\u975e\u679a\u4e3e\u7c7b\u578b");
                    return false
                }
                if (className == "WebView" && methodName == "Toast") if (val == "success" || val == "warn" || val == "normal") ; else {
                    showMistake(val, "\u975e\u679a\u4e3e\u7c7b\u578b");
                    return false
                }
                break
            ...
            case "source": {
                if (className == "Pay") if (typeof val ==
                    "string") ; else {
                    showMistake(val, "\u975e\u5b57\u7b26\u4e32\u7c7b\u578b");
                    return false
                } else {
            ...
            default: {
                if (key.indexOf("_list") > 0) {
                    ...
                    for (var _i = 0; _i < val.length; _i++) _flag = checkParams(keyType, val[_i], className, methodName) && _flag;
                    return _flag
                }
                break
            }
    ...
    function setInterface(obj) {
        ...
        if (!params) {
            params = {};
            console.warn("\u6ce8\u610f\uff0c\u8c03\u7528\u4e86" +
                className + "." + methodName + "\u65b9\u6cd5\uff0c\u6ca1\u6709\u4f20\u9012\u53c2\u6570")
        ...
        if (!callback) console.warn("\u6ce8\u610f\uff0c\u8c03\u7528\u4e86" +
            className + "." + methodName + "\u65b9\u6cd5\uff0c\u6ca1\u6709\u4f20\u9012\u56de\u8c03\u51fd\u6570"); else if (typeof callback != "function") {
        ...
        if (paramsType == "json") {
            ...
            if (params["callback"] && typeof params["callback"] == "function") {
                callbackList[className + "_" + methodName + "_" + port] = params["callback"];
                params["callback"] = "ek.ac.callbackList." + className + "_" + methodName + "_" + port
            }
            ...
            } else if (checkParams(i, params[i], className, methodName)) if (i.indexOf("_list") > 0) paramsStr = paramsStr + "&" + i + "=" + encodeURIComponent(JSON.stringify(params[i])); else paramsStr = paramsStr + "&" + i + "=" + encodeURIComponent(params[i]); else return {
                or: function or() {
                }
            };
        ...
        function consoleTxcomic(appType,
                                interfaceType) {
            acOutput("\u8c03\u7528 " + className + "|" + methodName + " - " + port, {send: interfaceType + "://" + className + ":" + port + "/" + methodName + "?" + decodeURIComponent(paramsStr)})
        }
        ...
        if (isAndroidApp) {
            ...
            reportClick$1(className,
                methodName, "in" + business);
            if (VER_NUMBER >= 12) {
    ...
    var inform$1 = function inform(port, res, resDes) {
        resDes = resDes || {};
        acOutput("\u56de\u8c03 " + controlList[port]["interfaceName"] +
            " - " + port, {res: res, resDes: resDes});
        var iframe = document.querySelector('iframe[data-port="' + port + '"]');
        if (iframe) iframe.setAttribute("data-use", "true");
        if (resDes.from_server) controlList[port]["callback"].call(this, res); else if (res.status == 1) controlList[port]["callback"].call(this, res); else if (res.status == 2) {
            ...
            -99) Pre_Callbacks.unLogin.call(this, res); else if (res.status == -2) Pre_Callbacks.missApi.call(this, res); else if (res.status == -1) Pre_Callbacks.mistake.call(this, res); else if (res.status == -3) Pre_Callbacks.discardApi.call(this, res)
    };
    ...
    function registerInterface(name, business) {
        return {
            User: function User(params, callback) {
                ...
                return setInterface({
                    className: "Client", methodName: name,
                    params: params, callback: callback, business: business
                })
    ...
    for (var i$1 in User) {
        ...
        for (var j in UserUpdate) if (j == i$1) {
    ...
    var Share = {SetConfig: sample, PopUp: sample, Screenshot: sample};
    for (var _i4 in Share) {
        Share[_i4] = registerInterface(_i4)["Share"];
    ...
    var WebViewUpdate = {Back: "Back_v2"};
    for (var _i5 in WebView) {
        ...
        for (var _j2 in WebViewUpdate) if (_j2 == _i5) {
            WebView[_i5] = registerInterface(WebViewUpdate[_j2])["WebView"];
            WebView[interfaceLowerCase(_i5)] = registerInterface(WebViewUpdate[_j2])["WebView"]
        }
    }
    var Connect = {Get: sample, Post: sample};
    ...
    Business.TodayTaskShareComic =
        registerInterface("CallUpBookshelfOfCollect", "TodayTask")["Client"];
    Business.TodayTaskCommunityKOLAddLike = registerInterface("CallUpCommunityKOL", "TodayTask")["Client"];
    ...
    Business.TodayTaskHomeUpdate = registerInterface("CallUpHomeOfUpdate",
        "TodayTask")["Client"];
    var acApp = {
    ...
    var CB = {
        callback2string: function callback2string(callback, keepAfterExec) {
            ...
            if (typeof func == "string") func =
                func.anonymousCallbackExposer.parse(func);
            return func
    ...
    var _prompt = function () {
        if (isAndroidApp) return function (params, forceAsync) {
            ...
            var iframes = {box: null, lastUsed: 0, list: []};
            var total = 10, createIframes = function createIframes() {
                if (iframes.box) return;
                var box = document.createElement("div");
                box.className = "call-client-iframes";
                box.style.display = "none";
            ...
            return window["callClient"] = function (params, forceAsync) {
                if (!iframes.box) if (document.body) createIframes(); else {
    ...
    function isAppLogin(_callback) {
        var json = {
            "interface": "isLogin", "callback": function callback(response) {
                var obj = response;
                obj = CB.string2obj(obj);
                _callback = CB.string2callback(_callback);
                if (obj && obj.ret == 1) _callback(obj); else {
    ...
    function appLogin(callback) {
        var json = {"interface": "appLogin", "callback": callback};
        if (isAndroidApp) {
            json.callback = function (response) {
                var obj = response;
                obj = CB.string2obj(obj);
                callback = CB.string2callback(callback);
                if (obj && obj.ret == 1) isAppLogin(callback); else callback(null)
            };
    ...
    function appRelogin(loginShowType, _callback2) {
        ...
        var json = {
            ...
            "callback": function callback(response) {
                ...
                if (obj && obj.ret == 1) isAppLogin(_callback2); else _callback2(null)
            }
        };
    ...
    function goComicDetail(comicId) {
        if (!comicId) return;
        var json = {"interface": "goComicDetail", "data": {id: comicId}};
        _prompt(json)
    }

    function goUserCenter() {
        if (isIOS ||
            isAndroid && appVer >= 5.2) {
            var json = {"interface": "goUserCenter", "data": {}};
            _prompt(json)
    ...
    function goVisitorCenter(uin) {
        if (isIOS || isAndroid && appVer >= 5.3) {
            var json = {"interface": "goVisitorCenter", "data": {uin: uin}};
            _prompt(json, true)
    ...
    function goGround() {
        if (isIOS || isAndroid && appVer >= 5.4) {
            var json = {"interface": "goGround", "data": {}};
            _prompt(json)
    ...
    function goHistory() {
        if (isIOS || isAndroid && appVer >= 5.4) {
            var json = {"interface": "goHistory", "data": {}};
            _prompt(json)
    ...
    function goHomePage() {
        if (isIOS || isAndroid && appVer >= 6.3) {
            var json = {"interface": "goHomePage", "data": {}};
            _prompt(json)
    ...
    function goAnimationList() {
        if (isIOS || isAndroid && appVer >= 6.3) {
            var json = {"interface": "goAnimationList", "data": {}};
            _prompt(json)
    ...
    function goTopicDetail(id, topicId) {
        if (isIOS || isAndroid && appVer >= 5.4) {
            ...
            var json = {"interface": "goTopicDetail", "data": {id: id, topic_id: topicId}};
            _prompt(json)
    ...
    function collectComic(comicId, title, coverUrl, latedSeqno, callback) {
        ...
        if (isIOS || isAndroid && appVer >= 5.2) {
            var json = {
                ...
                "data": {comic_id: comicId, title: title, cover_url: coverUrl, lated_seqno: latedSeqno}
            };
            _prompt(json, true)
        }
    }
    ...
    function getReadHistory(comicId, callback) {
        ...
        if (isIOS || isAndroid && appVer >= 5.2) {
            var json =
                {"interface": "getReadHistory", "callback": CB.parseCallbackRes(callback), "data": {comic_id: comicId}};
            _prompt(json, true)
        }
    }
    ...
    function setReadHistory(comicId, title, coverUrl, cid, seq, callback) {
        ...
        if (isIOS || isAndroid && appVer >= 5.2) {
            var json = {
                ...
                "callback": CB.parseCallbackRes(callback),
                "data": {comic_id: comicId, title: title, cover_url: coverUrl, chapter_id: cid, seq_no: seq}
            };
            _prompt(json, true)
        }
    }
    ...
    function vipPay(month, aid) {
        ...
        aid = aid === undefined ? "h5_app_pay" :
            aid;
        var json = {"interface": "payVip", "data": {month: month, aid: aid}};
        _prompt(json)
    }
    ...
    function deviceInfo(callback) {
        var json = {"interface": "device_info", "callback": CB.parseCallbackRes(callback)};
        _prompt(json, true)
    }

    function getAppNetWorkState(_callback3) {
        var json = {
            "interface": "getAppNetWorkState", "callback": function callback(getAppNetWorkState) {
                var obj =
                    getAppNetWorkState;
                obj = CB.string2obj(obj);
                _callback3(obj)
    ...
    function goMidasDq(dq, canChange, pf, callback) {
        if (isIOS || isAndroid && appVer >= 5.4) {
            ...
            pf = pf || "20120321";
            var json = {"interface": "goMidasDq", "callback": callback, "data": {dq: dq, pf: pf, canChange: canChange}};
            _prompt(json)
        }
    }
    ...
    function goMidasVIP(month, aid, callback) {
        if (isIOS || isAndroid && appVer >= 5.4) {
            var productId = {
                1: "MHVIPD1",
                3: "MHVIPB3", 6: "MHVIPC6", 12: "MHVIPA12"
            }[month];
            if (!productId) throw new Error("\u5f00\u901a\u6708\u4efd\u6570\u6709\u8bef\uff0c\u4e0d\u80fd\u4e3a " + month);
            var json = {"interface": "goMidasVIP", "callback": callback, "data": {productId: productId, aid: aid}};
            _prompt(json)
        }
    }
    ...
    function goMidasVIPList(aid, callback) {
        if (isIOS || isAndroid && appVer >= 5.4) {
            var json = {"interface": "goMidasVIPList", "callback": callback, "data": {aid: aid}};
            _prompt(json)
        }
    }
    ...
    function readBagPage(pf, callback) {
        ...
        if (isIOS || isAndroid && appVer >= 6.2) {
            var json = {"interface": "read_bag_page", "callback": callback, "data": {"pf": pf}};
            _prompt(json)
        }
    }
    ...
    function readBagPurchase(pf, readBagId, callback) {
        ...
        if (isIOS || isAndroid && appVer >= 6.2) {
            var json = {
                ...
                "callback": callback,
                "data": {"pf": pf, "read_bag_id": readBagId}
            };
            _prompt(json)
        }
    }
    ...
    function changeOrientation(screenType, callback) {
        if (isIOS || isAndroid && appVer >= 6.2) {
            var json = {
                ...
                "data": {screen_type: screenType}, "callback": callback || ""
            };
            _prompt(json)
        }
    }
    ...
    function nativeEditor(visibleType, callback) {
        if (isIOS || isAndroid && appVer >= 6.2) {
            if (typeof callback == "function") callback = CB.callback2string(callback, true);
            var json = {"interface": "event_editor", "data": {"visible_type": visibleType}, "callback": callback || ""};
            _prompt(json)
        }
    }
    ...
    function setTopBarState(visibleType, callback) {
        if (isIOS || isAndroid && appVer >= 6.2) {
            var json = {
                "interface": "event_topBarState", "data": {"visible_type": visibleType}, "callback": callback ||
                ""
            };
            _prompt(json)
        }
    ...
    function dqIap(dq, callback) {
        if (isIOS) {
            var json = {"interface": "dqIap", "callback": CB.parseCallbackRes(callback), "data": {dq: dq}};
            _prompt(json)
        }
    }
    ...
    function readBagIap(readBagId, isVip, callback) {
        if (isIOS) {
            ...
            var priceList = {1010: [1, 1], 8040: [8, 6]};
            var json = {
                "interface": "readBagIap",
                "callback": CB.parseCallbackRes(callback),
                "data": {read_bag_price: priceList[readBagId][isVip], read_bag_id: readBagId}
            };
            _prompt(json)
        }
    }
    ...
    function payVipIap(month, callback) {
        if (isIOS) {
            var json =
                {"interface": "payVipIap", "callback": CB.parseCallbackRes(callback), "data": {month: month}};
            _prompt(json)
        }
    }
    ...
    function setShare(_shareConfig) {
        if (Object.prototype.toString.call(arguments[0]) === "[object Object]") for (var k in _shareConfig) {
            if (_shareConfig.hasOwnProperty(k)) shareConfig[k] =
                _shareConfig[k]
    ...
    function appShare(cb) {
        ...
        if (VER_NUMBER > 0) Share.PopUp(); else share({
            "imgurl": shareConfig.img_url, "title": shareConfig.title, "content": shareConfig.desc,
            "pageurl": shareConfig.link, "callback": function callback(res) {
    ...
    function setAppShare() {
        if (VER_NUMBER > 0) Share.SetConfig({
            ...
            "imgurl": shareConfig.img_url, "title": shareConfig.title, "content": shareConfig.desc,
            "pageurl": shareConfig.link, "callback": shareConfig.callback
        })
    }
    ...
    function setWxShare() {
        ...
        var _share = function _share() {
            try {
                WeixinJSBridge.on("menu:share:timeline",
                    function (argv) {
                        var shareContent = wxShareContent, callback = shareContent.callback;
        ...
        if (window.WeixinJSBridge && typeof WeixinJSBridge.invoke == "function") _share(); else if (document.addEventListener) document.addEventListener("WeixinJSBridgeReady", _share, false); else if (document.attachEvent) {
    ...
    if (clientType === CLIENT.QQ) {
        var onGotApi = function onGotApi() {
            var cache = _setQQShare2.cache, mqqData = window["mqq"] && window["mqq"].data,
                setShare = mqqData && mqqData.setShareInfo;
            cache && setShare.apply(setShare || window, cache);
            _setQQShare2 = setShare
        };
        typeof mqq != "undefined" ? onGotApi() : loadScript("https://pub.idqqimg.com/qqmobile/qqapi.js",
            onGotApi)
    }
    ...
    if (clientType === CLIENT.QQBROWSER) loadScript("http://jsapi.qq.com/get?api=app.canShareTo,app.setShareInfo,app.share",
        function () {
            var cache1 = _setQQBrowserShare2.cache, cache2 = _QQBrowserShare2.cache,
                browserApp = window["browser"] && window["browser"].app,
                setShare = browserApp && browserApp.setShareInfo, share$$1 = browserApp && browserApp.share;
    ...
    function prpr(pid) {
        return callClient("txcomic://prpr/path?pid=" +
            pid)
    }
        ...
        var pt_logout =
            {
                ...
                nlog: function nlog(o, t, n) {
                    if (Math.random() <= (n || 1)) {
                        var e = "https:" == location.protocol ? "https://ssl.qq.com/ptlogin/cgi-bin/ptlogin_report?" :
                            "http://log.wtlogin.qq.com/cgi-bin/ptlogin_report?", p = location.href,
                            i = encodeURIComponent(o + "|_|" + p + "|_|" + window.navigator.userAgent),
                            l = e + "mid=" + t + "&msg=" + i + "&v=" + Math.random(), u = new Image;
                        u.src = l
                    }
                },
                init: function init() {
                ...
                getLogoutUrl: function getLogoutUrl(o) {
                    var t = pt_logout.getCookie("pt4_token"), n = pt_logout.getCookie("skey"), e = pt_logout.time33(n),
                        p = pt_logout.getCookie("ptcz"), i = pt_logout.hash33(p), l = "",
                        u = o ? "qq.com" : pt_logout.mainDomain;
                    return l = ("https:" == location.protocol ? "https://ssl." : "http://") + "ptlogin2." + u + "/logout?", l += "pt4_token=" + t + "&pt4_hkey=" + e + "&pt4_ptcz=" +
                        i + "&deep_logout=1"
                },
                ...
                clearCookie: function clearCookie(o) {
                    o = o || pt_logout.appDomain, pt_logout.delCookie("p_uin", o), pt_logout.delCookie("p_skey", o), pt_logout.delCookie("p_luin", o), pt_logout.delCookie("p_lskey", o), pt_logout.delCookie("pt4_token", o), pt_logout.delCookie("pt_mbkey", pt_logout.mainDomain ||
                        "qq.com"), "" != pt_logout.appDomain && "" != pt_logout.getCookie("skey_m") && (pt_logout.delCookie("uin_m", pt_logout.appDomain), pt_logout.delCookie("skey_m", pt_logout.appDomain))
                },
                set_ret: function set_ret(o, t) {
                    try {
                        var n = pt_logout.getCookie("pt4_token");
                        pt_logout.clearCookie(t), o > 0 || (pt_logout.delCookie("uin", pt_logout.mainDomain), pt_logout.delCookie("skey", pt_logout.mainDomain), pt_logout.nlog("logout fail", "285851", .1)), "function" == typeof pt_logout.callback && pt_logout.callback(2), "" != t && t != pt_logout.appDomain &&
                        pt_logout.nlog("domain unsame:n=" + o + ":pt4_token=" + n + ":cgi_domain=" + t + ":js_domain=" + pt_logout.appDomain, "285852", .1)
                    } catch (e) {
                        return
                    }
                },
                logout: function logout(o, t) {
                    pt_logout.init();
                    var n = pt_logout.getCookie("pt4_token"), e = pt_logout.getCookie("skey"),
                ...
                logoutQQCom: function logoutQQCom(o) {
                    pt_logout.logout(o,
                        !0), pt_logout.delCookie("uin", pt_logout.mainDomain), pt_logout.delCookie("skey", pt_logout.mainDomain)
                }
            };
    ...
    function login(backUrl, useOneKey) {
        ...
        window.location.href = "http://ui.ptlogin2.qq.com/cgi-bin/login?style=9&low_login=1&appid=637009801&daid=43" + "&pt_no_onekey=" + (useOneKey ? "0" :
            "1") + "&s_url=" + backUrl
    }
    ...
    function isLogin() {
        ...
        if (!uin || uin == "0") return null; else return {uin: uin, skey: skey, lskey: lskey}
    }
    ...
    var loginLite = {login: login, isLogin: isLogin, isLogin_async: isLogin_async, logout: logout};
    !function () {
        function e(e) {
            var i, n = e.source;
            ...
            var t = document.getElementsByTagName("head")[0], o = document.createElement("script"),
                a = function a() {
                    if (o) {
                        ...
                        o.removeEventListener("load", a), t.removeChild(o), o = null, "function" == typeof i && i(n, !0)
                    }
                };
            o.addEventListener("load", a), o.src = e, t.insertBefore(o, t.firstChild)
        }

        var t = {}, o = 0, a = function a(e) {
            this.name = "midas_iframe_" + o, e.name = this.name, this.iframeDom = e, this.contentWindow = e.contentWindow, t[this.name] = this, this.handlers = {}, o++
        };
        a.prototype = {
            on: function on(e, i, n) {
                this.handlers[e] = this.handlers[e] || [], this.handlers[e].push({handler: i, self: n})
            }, off: function off(e,
                                 i) {
                ...
                this.contentWindow.postMessage(JSON.stringify(e), "*"), window.console && console.log("\nSend cross orign stream \nFROM:" + location.href + '\nTO:frames["' + this.name + '"]\nDATA:' + JSON.stringify(e) + "\n")
            }, close: function close() {
                delete t[this.name]
            }, _handle: function _handle(e,
                                         i) {
                var n = this;
        ...
        }, window.addEventListener("message", e), window.addEventListener("beforeunload", function () {
            window.removeEventListener("message", e)
        });
        var s = function s() {
            var e = this.section = document.createElement("div");
            e.style.cssText = ["position:absolute;left:0;top:0;width:100%;z-index:999;background:rgba(0,0,0,0.7);"].join(""), this.resize(), document.body.appendChild(e)
        };
        s.prototype = {
        ...
        var d = function d() {
            var e = this.section = document.createElement("div");
            e.className = "fpm-loading", e.innerHTML = '<i class="fpm-loading-dot"></i><i class="fpm-loading-dot"></i><i class="fpm-loading-dot"></i>', document.body.appendChild(e)
        };
        d.prototype = {
            hide: function hide() {
        ...
        }([".fpm-loading {padding:0;margin:0;border:0;outline:0;font-weight:inherit;font-style:inherit;font-family:inherit;font-size:100%;vertical-align:baseline;width:100%;box-sizing:border-box;text-align:center;position:fixed;left:0;top:50%;transform:translateY(-50%);z-index:1000}",
            ".fpm-loading-dot {background:#9e9e9e;display:inline-block;*display:inline;*zoom:1;width:12px;height:12px;border-radius:12px;margin-right:15px;-webkit-animation-name:fpm-loadingAnim;animation-name:fpm-loadingAnim;-webkit-animation-duration:1s;animation-duration:1s;-webkit-animation-timing-function:ease;animation-timing-function:ease;-webkit-animation-iteration-count:infinite;animation-iteration-count:infinite;-webkit-animation-delay:0.3s;animation-delay:0.3s;}", ".fpm-loading-dot:first-child {-webkit-animation-delay:0s;animation-delay:0s;}",
            ".fpm-loading-dot:last-child {-webkit-animation-delay:0.6s;animation-delay:0.6s;margin-right:0;}", "@-webkit-keyframes fpm-loadingAnim {0% {opacity:0.5;}100% {opacity:1;}}", "@keyframes fpm-loadingAnim {0% {opacity:0.5;}100% {opacity:1;}}"].join("\r\n"));
        var c = [], r = function r(e) {
            var i, n = navigator.userAgent;
            n.indexOf("Android") > -1 && (i = parseFloat(n.slice(n.indexOf("Android") + 8))), this.iframeDom = document.createElement("iframe"), this.iframeDom.style.cssText = ["border:0;position:", 4 > i ? "absolute" : "fixed",
                ";left:0;top:0px;width:100%;height:", document.documentElement.clientHeight, "px;z-index:2000;"].join(""), this.iframeDom.scrolling = "auto", this.iframeDom.src = e.url, document.body.appendChild(this.iframeDom), this.stream = new a(this.iframeDom), this.shader = new s, this.loading = new d;
        ...
        r.prototype = {
            close: function close() {
                document.body.removeChild(this.iframeDom),
                    this.iframeDom = null, this.stream.close(), this.stream = null, this.shader.hide(), this.shader = null, c.splice(c.indexOf(this), 1)
            }, on: function on(e, i, n) {
        ...
        u.API_VERSION = 5;
        var l = "https:" === location.protocol ? "https:" : "http:", h = u.buyGoods = function (e) {
            if (!e.params) return alert("Midas.buyGoods params not specified."), !1;
            ...
            1 == e.sandbox ? i.sandbox = 1 : 2 == e.sandbox &&
                (i.sandbox = 2), ["wxAppid", "wxAppid2", "mpid", "u", "sid", "dc", "groupid", "showprovide", "shownick", "schema", "schema_url", "pfkey", "_version", "openid", "openkey", "sessionid", "sessiontype"].forEach(function (n) {
                void 0 !== e[n] && (i[n] = encodeURIComponent(e[n]))
            });
            var n = [];
            for (var t in i) n.push(t + "=" + i[t]);
            h._dlg = new r({
                url: l + "//pay.qq.com/h5/index.shtml?" + n.join("&"), methods: {
                    ...
                    close: function close() {
                        this.close(), h._dlg = null, e.onClose && e.onClose()
                    },
            ...
            if ("qq" !== e.account && "wechat" !== e.account) return alert("Midas.rechargeGameCurrency account not valid."), !1;
            var i = {
                m: "buy",
                c: {qq: "game", wechat: "wechat_game"}[e.account],
                dialog: "1",
                midasApiVersion: u.API_VERSION,
                dh: "1",
                pf: e.pf,
            ...
            1 == e.sandbox ? i.sandbox = 1 : 2 == e.sandbox && (i.sandbox = 2), ["n", "da", "al", "as", "hideInfo", "hidePrice", "wxAppid", "shownick", "groupid", "wxAppid2", "mpid", "u", "u2", "dc", "pfkey",
                "schema", "schema_url", "openid", "openkey", "sessionid", "sessiontype"].forEach(function (n) {
                void 0 !== e[n] && (i[n] = encodeURIComponent(e[n]))
            });
            var n = [];
            for (var t in i) n.push(t + "=" + i[t]);
            p._dlg = new r({
                url: l + "//pay.qq.com/h5/index.shtml?" + n.join("&"), methods: {
                    ...
                    close: function close() {
                        this.close(), h._dlg = null, e.onClose &&
                        e.onClose()
                    },
                    resize: function resize(e) {
                        e.height && (this.iframeDom.style.height = e.height + "px")
            ...
            var i = {
                    m: "buy",
                    c: {qq: "qqsubscribe", wechat: "subscribe"}[e.account],
                    dialog: "1",
                    midasApiVersion: u.API_VERSION,
                    dh: "1",
                    appid: e.appid,
            ...
            window.MidasJSBridge && n.push("sdkpay"), n.forEach(function (n) {
                void 0 !== e[n] && (i[n] = encodeURIComponent(e[n]))
            }),
            ...
            m._dlg = new r({
                url: l + "//pay.qq.com/h5/index.shtml?" + t.join("&"), methods: {
                    wechat_buy: g.wechat_buy,
                    mqq_buy: g.mqq_buy,
                    wechat_wapbuy: g.wechat_wapbuy,
                    mqq_wapbuy: g.mqq_wapbuy,
            ...
            var i = {m: "buy", c: e.c, dialog: "1", midasApiVersion: u.API_VERSION, dh: "1", pf: e.pf},
                n = ["account", "shownick", "n", "da", "aid", "u", "u2", "mode", "fixed_mode", "mpid", "al", "ap", "sl", "tabService", "dc", "coupons_ext", "tc", "appid", "groupid", "schema", "schema_url", "configs", "as", "open_detail", "paybyday", "wxAppid", "wxAppid2", "sid", "hideInfo",
                    "hidePrice", "pfkey", "openid", "openkey", "sessionid", "sessiontype"];
            window.MidasJSBridge && n.push("sdkpay"), n.forEach(function (n) {
                void 0 !== e[n] && (i[n] = encodeURIComponent(e[n]))
            ...
            wechat_buy: function wechat_buy(e) {
                ...
                WeixinJSBridge.invoke("getBrandWCPayRequest", {
                    ...
                    i.postMessage({action: "wechat_buy", data: {res: e}})
                })
            },
            mqq_buy: function mqq_buy(e) {
                function i() {
                    mqq.tenpay.pay(e.info, function (e) {
                        t.postMessage({action: "mqq_buy", data: {res: e}})
                    })
                }
                ...
                MidasJSBridge.call(e.cmd, e.params, function (e) {
                        i.postMessage({action: "MidasJSBridge_call", data: {res: e}})
                    },
                    "")
                ...
                function e(e) {
                    i.postMessage({action: "MidasJSBridge_detect", data: {result: e}})
                }
    ...
    function vipDialog(month, pf, cb) {
        ...
        if (!isApp) vipDialog_h5(month, pf, cb); else if (isAndroid) goMidasVIP(month, aid, function (res) {
            cb({ret: res == 1})
    ...
    function vipDialog_h5(month, pf, cb) {
        pf = pf || "event2208";
        var aid = "h5_event_" + pf;
        var productId = {1: "MHVIPD1", 3: "MHVIPB3", 6: "MHVIPC6", 12: "MHVIPA12"}[month];
        if (!productId) throw new Error("\u5f00\u901a\u6708\u4efd\u6570\u6709\u8bef\uff0c\u4e0d\u80fd\u4e3a " + month);
        var isSuccess = false;
        Midas.openSubscribe({
            account: "qq",
    ...
    var DQ_LEVELS = {100: 100, 600: 600, 3E3: 3E3, 5E3: 5E3, 9800: 9800};

    function dqDialog_h5(dq,
                         pf, cb) {
    ...
    function readBagDialog(price, pf, cb) {
        pf = pf || "event2208";
        var bagId = {1: 1010, 8: 8040}[price];
        if (!isApp) readBagDialog_h5(price, pf, cb); else if (isAndroid) readBagPurchase(pf, bagId, function (res) {
            cb({ret: res == 1})
        }); else if (isIOS) readBagIap(bagId,
            0, cb)
    }
    ...
    function buyVip(retUrl, aid) {
        ...
        window.location.href = pageHref.appendQueryString("/home/buyVip", {"retUrl": retUrl, "aid": aid})
    }
...
(function () {
    ...
    BackToTop.prototype = {
        init: function (para) {
            ...
            var that = this;
            var scrollElem =
                that.scrollElem, box = scrollElem == document.body ? document.documentElement : scrollElem;
            box.scrollTop = scrollElem.scrollTop = window.scrollY = window.pageYOffset = 0
        }, "bindScroll": function () {
            var that = this;
            var scrollElem = that.scrollElem, box = scrollElem == document.body ? document.documentElement : scrollElem,
                tar = scrollElem == document.body ? window : scrollElem, limit = that.scrollLimit;
            tar.addEventListener("scroll", function () {
                var scrollTop = box.scrollTop || scrollElem.scrollTop || window.scrollY || window.pageYOffset;
                if (scrollTop >=
                    limit && !that.disabled) that.dom.addClass("show"); else that.dom.removeClass("show")
            })
        }, "disable": function () {
            var that = this;
            that.disabled = true;
...
$(function () {
    var checkClickAppAds = function (e) {
        ...
        if ($close.length) {
            ...
            if (url_Android && url_iOS) if (ek.isIOS) callUpOrDown(url_iOS, tag); else {
                if (ek.isAndroid) callUpOrDown(url_Android, tag)
            } else callUpOrDown()
        }
    };
    var callUpOrDown = function (url, tag) {
        var pageHref = window.location.href, matchId = /\/id\/([0-9]+)/g.exec(pageHref),
...
(function () {
    function createBlockDialog() {
        var blocker = new Blocker({timeKey: "default"});
        var dialog = new Dialog({
            title: '<i class="small-icon"></i>\u817e\u8baf\u52a8\u6f2bAPP',
            prop: {skin: "light-salmon", cover: true, closeBtn: true, lock: true},
            content: ['<em class="em">\u66f4\u65b0\u66f4\u5feb\u3001\u6d41\u91cf\u8d85\u7701\u3001\u5185\u5bb9\u66f4\u5168</em>', "\u5b89\u88c5\u817e\u8baf\u52a8\u6f2bAPP\uff0c\u5373\u4eab\u6240\u6709\uff01", new PileDialogRow({
                content: [{
                    ...
                    text: "\u5b89\u88c5\u4eab\u798f\u5229", style: {flex: 1, marginLeft: 0}, click: function () {
                        ek.ping.reportClick("h5_v3_app_down.box_block.down_app");
                        var url = window.location.href, matchId = /\/id\/([0-9]+)/g.exec(url),
                            id = parseInt(matchId && matchId[1]);
                        if (ek.clientType == ek.CLIENT.WEIBO) {
                            var hideTips = function () {
                                $tips.hide().off("click", hideTips)
    ...
    function tryCreate() {
        if (window.Dialog) createBlockDialog(); else window.setTimeout(tryCreate, 50)
    }
...
(function () {
    var wl = window.location, href = wl.href, prefix = wl.protocol + "//" + wl.hostname, uri = href.replace(prefix, "");
    ...
    function checkOrientation() {
        if (window.orientation == "-90" || window.orientation == "90") {
            ...
            if (wl.indexOf(ek.url.getDomain() + "/chapter/index/") == -1) {
                if (onVertical == undefined) onVertical = false; else if (onVertical == true) onVertical = false;
                Dialog.toast("\u7ad6\u5c4f\u770b\u6f2b\u753b\u66f4\u723d\u54e6\uff0c\u8f6c\u4e00\u4e0b\u561b\u256e(\u256f\u25bd\u2570)\u256d")
            }
        } else if (onVertical == undefined) onVertical = true; else if (onVertical == false) onVertical =
            true
    }
...
window.pageAction = function () {
    ...
    PageAction.prototype = {
        goBack: function () {
            if (document.referrer) window.history.go(-1); else {
                var backAddress = $('meta[name="backAddress"]').attr("content");
                if (backAddress) window.location.href = backAddress; else window.location.href = "/"
            }
        }, getLogin: function (cb) {
            ek.isApp ? ek.app.isAppLogin(cb) :
                ek.loginLite.isLogin_async(cb)
        }, goLogin: function (retUrl) {
            retUrl = retUrl || window.location.href;
            ek.isApp ? ek.app.appLogin(function () {
                if (window.location.href === retUrl) window.location.reload(); else window.location.href = retUrl
...
var TokenKey = {
    _data: undefined, _loading: false, clearCache: function () {
        this._data = null
    }, set: function (token) {
        if (!token) return;
        this._data = token
        ...
        self._loading = true;
        ek.ajax({
            url: "/Ajax/getToken", data: {}, success: function (res) {
                console.log("\u8bf7\u6c42\u6210\u529f\uff1a", this);
                console.log("\u8fd4\u56de\u6570\u636e\uff1a", res);
                self._loading =
                    false;
                var data = res && res.data, token = data && data.token || "";
                self._data = token;
                cb && cb(token)
            }
        })
...
!function (a) {
    function b(a) {
        var b = new RegExp("(^|&)" + a + "=([^&]*)(&|$)"), c = location.search.substr(1).match(b);
        return null != c ? decodeURIComponent(c[2]) : null
    }

    function c() {
        var a = "iframe_hijack_redirected";
        if (b(a)) f(0); else if (self != top) {
            var c = location.href, d = c.split("#");
    ...
    function d() {
        if (a.XMLSerializer) {
            var b = (new XMLSerializer).serializeToString(document), c = b.match(/\x3c!--headTrap.*?--\x3e/),
    ...
    function e(a) {
        ...
        if (b.outerHTML) {
            ...
            for (var i = 0; i < g.length; i++) {
                var j = g[i], l = null;
                if ("IMG" == j.nodeName.toUpperCase() && j.src && d.test(j.src)) l = [j.src]; else if ("LINK" == j.nodeName.toUpperCase()) {
                    var m =
                        j.getAttribute("href");
                    m && d.test(m) && (l = [m])
    ...
    function f(a, b) {
        if (!l[a]) {
            l[a] = !0;
            var c = {project_id: j, department_id: i, hijack_type: a, page_url: location.href, blocked: 1};
    ...
    function g() {
        50 * Math.random() <
        1 && h({project_id: j, department_id: i, pv: 1})
    }
    ...
    function h(a) {
        ...
        d.open("POST", "http://hijack.qq.com/cgi/r", !0), d.setRequestHeader("Content-Type", "application/x-www-form-urlencoded"), d.send(b.join("&"))
    }

    var i, j, k = /^.*\.(qq\.com|gtimg\.cn|qlogo\.cn|qpic\.cn|sogoucdn\.com)$/i, l = {};
    a.HijackReport = {
        init: function (a) {
            i = a.departmentId, j = a.projectId, a.whiteReg && (k = a.whiteReg)
        }, watch: function () {
            a.addEventListener("DOMNodeInserted",
                e), c(), document.addEventListener("DOMContentLoaded", function () {
                e(), d(), g()
            }, !1)
        }
    }
...
(function () {
    function initUlink($target, dm, str, cssObj) {
        ...
        if (ek.isIOS && !ek.isApp) {
            if ($target.is("a")) $target.attr({"data-ulink": "ulink", "href": href + dm + "/" + str}); else {
